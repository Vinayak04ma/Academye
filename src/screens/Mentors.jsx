...
const Mentors = () => {
  const [mentors, setMentors] = useState(mentorsData);  // All mentors
  const [favorites, setFavorites] = useState([]);  // Favorite mentors
  const [viewFavorites, setViewFavorites] = useState(false);  // State to toggle between all and favorites view
