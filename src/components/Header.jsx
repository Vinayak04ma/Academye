...
//                         ))}
//                          <li className="font-semibold list-none text-[19px] cursor-pointer" key="7">
...
//     if (storedUsername) {
//       setUsername(storedUsername); // Retrieve username from localStorage and update state
//     }
...
//     setUsername(""); // Reset state to clear username in UI
//   };
